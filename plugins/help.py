...
def _source_code(client, message):
	...
	reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("Souce Code", url="https://github.com/selfie-bd/ForceSub_Bot")
                ],
                [
                    InlineKeyboardButton("Join Updates Channel", url="https://t.me/cinema_fix"),
                    InlineKeyboardButton("Support Group", url="https://t.me/joinchat/id3Pl3NaKcE2MzI1")
    ...
    if update_channel:
        try:
            ...
            if user.status == "kicked":
               client.send_message(
                   chat_id=message.chat.id,
                   text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/selfiebd).",
                   parse_mode="markdown",
                   disable_web_page_preview=True
               )
               return
